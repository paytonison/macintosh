...
const drawings: Record<PixelIconName, PixelRect[]> = {
  ...
  disk: [
    { x: 4, y: 3, width: 24, height: 26 },
    { x: 6, y: 5, width: 20, height: 13, color: 'white' },
    { x: 8, y: 7, width: 16, height: 2 },
    { x: 8, y: 11, width: 16, height: 1 },
    { x: 8, y: 15, width: 12, height: 1 },
    { x: 6, y: 21, width: 20, height: 6, color: 'white' },
    { x: 20, y: 22, width: 4, height: 4 },
    { x: 21, y: 23, width: 2, height: 2, color: 'white' },
    { x: 7, y: 28, width: 18, height: 2 },
  ],
  trash: [
